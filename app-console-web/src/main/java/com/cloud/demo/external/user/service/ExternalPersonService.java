package com.cloud.demo.external.user.service;

import com.cloud.demo.external.user.dto.Person;
import com.cloud.demo.external.user.service.fallback.ExternalPersonServiceFallback;
